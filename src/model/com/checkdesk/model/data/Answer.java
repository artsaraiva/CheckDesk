...
public class Answer  implements java.io.Serializable {
    ...
    public Answer(Survey survey, User owner, String feedback, Date occurredDate) {
        this.survey = survey;
        this.owner = owner;
        this.feedback = feedback;
        this.occurredDate = occurredDate;
    }
    public Answer(Survey survey, User owner, String feedback, Date occurredDate, Set questionAnswers, Set rankStatements) {
       this.survey = survey;
       this.owner = owner;
       this.feedback = feedback;
       this.occurredDate = occurredDate;
